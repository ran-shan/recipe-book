...
public class CreateRecipeDto {
    ...
    public CreateRecipeDto(String title, Boolean vegetarianDish, Integer numberOfPeople,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateRecipeDto)) {
            return false;
        }
        CreateRecipeDto other = (CreateRecipeDto) obj;
    ...
    public String toString() {
        return "CreateRecipeDto [title=" + title + ", vegetarianDish=" + vegetarianDish
                + ", numberOfPeople=" + numberOfPeople + ", cookingInstructions="
